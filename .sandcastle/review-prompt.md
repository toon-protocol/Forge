...
redundancy, unnecessary complexity, comment noise, standards violations that
can be corrected without changing behaviour.
...
2. Run Forge's gate to ensure nothing is broken — `eslint .`, `pnpm run typecheck`, `vitest run`, and `pnpm -r run build`
